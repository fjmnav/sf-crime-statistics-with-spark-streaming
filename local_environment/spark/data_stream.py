...
def run_spark_job(spark):
    ...
    # Since spark runs in the same network as kafka, I need to use the internal kafka broker port.
    df = spark \
        .readStream \
        .format("kafka") \
    ...
    radio_code_json_filepath = os.path.dirname(os.path.realpath(__file__)) + "/resources/radio_code.json"
